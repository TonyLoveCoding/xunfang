...
<div class="container clearfix div_container" >
    <div class="row div_row">
        <div class="col-md-4 column">
        </div>
        <div class="col-md-4 column  form-box">
            <h3 class="cursive-font text-center" id="h3_title">寻房网后台管理系统</h3>
            <form class="form-horizontal"  action="/login/login" method="POST">
                <div class="form-group">
                    <label for="id" class="col-sm-2 control-label lab_text">账号</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id" name="account" placeholder="输入你的账户"/>
                    </div>
                </div>
                <div class="form-group" method="post">
                    <label  class="col-sm-2 control-label lab_text">密码</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group"method="post">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-success" id="btn_login">登录</button>
                    </div>
                </div>
            </form>
        </div>
