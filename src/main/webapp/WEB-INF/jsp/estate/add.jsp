                ...
                <div class="btn-group">
                    <select name="location" value="${EstateDto.location}" class="btn btn-default dropdown-toggle">
                        <c:forEach var="dl" items="${dic_location}">
                            <option value="${dl.code}" <c:if test="${dl.code.equals(EstateDto.location) || (EstateDto.location==null && dl.code.equals('none'))}">selected</c:if>>${dl.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="btn-group">
                    <select name="type" value="${EstateDto.type}" class="btn btn-default dropdown-toggle">
                        <c:forEach var="dt" items="${dic_type}">
                            <option value="${dt.code}" <c:if test="${dt.code.equals(EstateDto.type) || (EstateDto.type==null && dt.code.equals('none'))}">selected</c:if>>${dt.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="col-sm-3" style="padding-left: 0px;padding-top: 10px">
                <select name="houseType" id="houseType" class="selectpicker show-tick form-control" multiple data-live-search="false">
                    <c:forEach var="dh" items="${dic_houseType}">
                        <option value="${dh.code}" <c:if test="${EstateDto.houseType.contains(dh.code) || (EstateDto.houseType==null && dh.code.equals('1'))}">selected</c:if>>${dh.name}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="col-sm-1 col-sm-offset-1" style="padding-left: 0px;padding-top: 10px">
            ...
            <div class="col-sm-3" style="padding-left: 0px;padding-top: 10px">
                <select name="feature" id="feature"class="selectpicker show-tick form-control" multiple data-live-search="false" >
                    <c:forEach var="df" items="${dic_feature}">
                        <option value="${df.code}" <c:if test="${EstateDto.feature.contains(df.code) || (EstateDto.feature==null && df.code.equals('1'))}">selected</c:if>>${df.name}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="col-sm-1 col-sm-offset-1" style="padding-left: 0px;padding-top: 10px">
